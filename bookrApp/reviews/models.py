...
class Publisher(models.Model):
    name = models.CharField(max_length=50, help_text="Nazwa wydawcy.")
...
class Contributor(models.Model):
    first_names = models.CharField(max_length=50, help_text="Imiona współtwórców.")
    last_names = models.CharField(max_length=90, help_text="Nazwiska współtwórców.")
    email = models.EmailField(help_text="Adres e-mail współtwórcy")
...
class BookContributor(models.Model):
    ...
    role = models.CharField(verbose_name="Rola współtwórcy w książce", choices=ContributionRole.choices, max_length=20)
